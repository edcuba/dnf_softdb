...
LD_LIBRARY_PATH=. g-ir-scanner `pkg-config --libs --cflags glib-2.0 gobject-2.0 sqlite3` --identifier-prefix=HifSwdb --symbol-prefix=hif_swdb --namespace HIF --nsversion=1.0 --library hif_swdb --warn-all -o HIF-1.0.gir hif_swdb.c hif_swdb.h
